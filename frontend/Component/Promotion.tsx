      ...
      <div className='justify-center w-full items-center gap-5 grid grid-cols-2 px-4 h-40 md:h-50'>
        {products.map((product,index)=>(
            <motion.div 
              ...
              viewport={{ amount: 0.4 }}
              key={index} 
              className='relative w-full rounded-xl overflow-clip h-40 md:h-50 text-white'>
                <Image className='hover:bg-[#1c1c1c55] w-full h-full object-cover hover:scale-120 transition-(scale) duration-300 ease-in-out' width={1920} height={1080} src={product} alt='product'/>
