...
export const Google = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-google" viewBox="0 0 16 16">
...
export const Category = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-columns-gap h-full w-full" viewBox="0 0 16 16">
...
export const AirConditioner = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-wind" viewBox="0 0 16 16">
...
export const SmartHome = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-house-gear-fill" viewBox="0 0 16 16">
...
export const Imgs = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="p-1 md:p-2 text-[#AAAAAA] bi bi-cloud-arrow-up-fill" viewBox="0 0 16 16">
...
export const List = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi-list-ul bi" viewBox="0 0 16 16">
...
export const Orderfill = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-box-seam-fill" viewBox="0 0 16 16">
...
export const Visit = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi-box-arrow-up-right bi" viewBox="0 0 16 16">
...
export const Cart = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-cart-fill size-full" viewBox="0 0 16 16">
...
export const Mobile = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-phone-fill" viewBox="0 0 16 16">
