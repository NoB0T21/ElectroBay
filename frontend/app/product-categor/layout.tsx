...
const Layout = ({children}:{children: React.ReactNode}) => {
  return (
    <div className='flex flex-col items-center px-3 justify-center scroll-smooth w-screen h-screen'>
      <div className='w-full max-w-280 h-full px-4 overflow-x-hidden shadow-2xl/30'>
        <Header/>
        <div className='flex flex-col justify-startm mt-3 gap-5 w-full h-full 2xl:h-[90%] py-2 overflow-hidden'>
          <ShopCategories2/>
          {children}
        </div>
      </div>
