...
router.get('/Get',rateLimiter(10,15),middleware,getproduct)
router.get('/homepage',rateLimiter(10,15),cachs,middleware,homepageData)
...
router.get('/:type',rateLimiter(10,5),middleware,getproductbyType)
