...
import { addproduct, Createorder, getallorder, getorder, getproduct, getproductbyId, getproductbyType, homepageData, updateorder } from "../Controller/product.controller";
